...
from .data_loader_rsvp import Dataset_RSVP_COCO
from conf import BaseConfig
from torch.utils.data import Dataset, DataLoader

data_dict = {
    'udf_viz_m': Dataset_UDF_VIZ_Cla_multiclass,
    'udf_viz_pair': Dataset_UDF_VIZ_Pair_multiclass,
    'rsvp_coco': Dataset_RSVP_COCO,
}
FLAGS = ['trn', 'val', 'tst']
